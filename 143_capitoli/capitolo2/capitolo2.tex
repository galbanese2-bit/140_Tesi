...
Assumendo funzioni di forma lineari per gli elementi, in Valvo \cite{Valvo1,Valvo2} la matrice di rigidezza elastica secante del singolo cavo $S_e \in \mathbb{R}^{6x6}$ viene espressa mediante la relazione:
\begin{equation}
