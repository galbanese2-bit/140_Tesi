...
In questo capitolo vengono presentati i principali modelli teorici e numerici utilizzati per descrivere il comportamento delle funi e, successivamente, delle reti di funi. La prima parte è dedicata alla meccanica delle funi, analizzata attraverso tre approcci di complessità crescente: il modello inestensibile, il modello ad elasticità diffusa e una formulazione alle differenze finite basata sulle equazioni indefinite di equilibrio. Questi modelli permettono di affrontare i due problemi classici della meccanica delle funi — la fune soggetta al peso proprio e la fune soggetta a un carico verticale distribuito — evidenziando analogie, differenze e limiti delle diverse formulazioni.
...
\begin{itemize}
   ...
   \item \textbf{Il modello alle differenze finite:} basato sulla risoluzione diretta alle equazioni differenziali indefinite di equilibrio di Irvine, permette di analizzare in modo rigoroso la distribuzione puntuale dello stato tensionale lungo il cavo. 
\end{itemize}
...
\end{itemize}
La fune inestensibile è un modello geometrico, non costitutivo, utile per determinare la forma assunta dalla fune quando viene raggiunto l'equilibrio statico ma incapace di rappresentare l'evoluzione deformativa o gli effetti della deformabilità assiale. 
