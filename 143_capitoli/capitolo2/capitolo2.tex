...
\begin{itemize}
   \item nel caso di fune lasca ($L_{eff} > l$), la forma analitica pura della catenaria viene approssimata dalla soluzione numerica tramite una parabola del $4^\circ$ ordine, generando una distribuzione caratteristica dell'errore lungo la campata;
