...
Nel primo diagramma (\cref{fig:estensibilevsinestensibile3}), che mette in relazione il tiro orizzontale $H$ con il rapporto di lassità $\xi$, si osserva come per $\xi < 0$ il modello estensibile descriva un comportamento lineare governato dalla rigidezza assiale $EA$ della fune. Al contrario, nel modello inestensibile la curva incontra un asintoto verticale in corrispondenza di $\xi \approx 0$, poichè il cavo non può subire accorciamenti al di sotto della distanza tra i vincoli. Il modello estensibile permette inoltre di cogliere il comportamento limite per $EA \rightarrow \infty$, caso in cui la curva elastica tende asintoticamente a quella inestensibile.

Analogalmente, nella figura successiva (\cref{fig:estensibilevsinestensibile4}), in cui la freccia massima $f$ è correlata al rapporto di lassità $\xi$, si nota l'incapacità del modello inestensibile di cogliere la risposta geometrica nelle condizioni di fune fortemente tesa ($\xi \le 0$). Nel modello estensibile è infatti possibile scorgere il comportamento asintotico della curva, il quale mostra come la freccia possa risultare rigorosamente nulla solamente al tendere a meno infinito del rapporto di lassità ($\xi \rightarrow -\infty$), ossia per un tiro orizzontale teoricamente infinito.
